...
st.set_page_config(layout="wide", page_title="AIRSA: Road Safety Assessment Tool", page_icon='traffic_light2.png',menu_items={'About': 'https://github.com/SaudAlzahri/AIRSA'})
